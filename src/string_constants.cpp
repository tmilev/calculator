...
std::string WebAPI::DatabaseParameters::findQuery = "findQuery";
...
std::string WebAPI::Result::deleteAccountToken = "deleteAccountToken";
...
std::string WebAPI::Request::newPassword = "newPassword";
std::string WebAPI::Request::reenteredPassword = "reenteredPassword";
...
std::string WebAPI::Request::deleteAccount = "deleteAccount";
...
std::string WebAPI::Request::desiredUsername = "desiredUsername";
...
std::string DatabaseStrings::resultContent = "content";
std::string DatabaseStrings::requestContent = "content";
std::string DatabaseStrings::requestOptions = "options";
std::string DatabaseStrings::requestProjectAwayFrom = "projectAwayFrom";
std::string DatabaseStrings::requestProjectInto = "projectInto";
std::string DatabaseStrings::messageId = "messageId";
std::string DatabaseStrings::messageHandle = "messageHandle";
std::string DatabaseStrings::messageSize = "messageSize";
std::string DatabaseStrings::requestType = "type";
std::string DatabaseStrings::error = WebAPI::Result::error;
std::string DatabaseStrings::maximumNumberOfItems = "maximumNumberOfItems";
