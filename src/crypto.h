...
public:
  ...
  int bitSize;
  // = ceiling(log_2 (pimeOne * primeTwo))
  int byteSize;
  // = ceiling (bitSize / 8)
...
public:
  ...
  static void convertListUint32ToString(
  ...
  static void appendDoubleSha256Check(
  ...
  static void convertUint64toBigendianStringAppendResult(
  ...
  static uint32_t leftRotateAsIfBigEndian(
    uint32_t input, int numberOfBitsToRotate
  );
  static uint32_t rightRotateAsIfBigEndian(
    uint32_t input, int numberOfBitsToRotate
  );
  static uint32_t rightShiftAsIfBigEndian(
    uint32_t input, int numberOfBitsToShift
  );
  static uint32_t leftShiftAsIfBigEndian(
    uint32_t input, int numberOfBitsToShift
  );
  static uint64_t leftRotateAsIfBigEndian64(
    uint64_t input, int numberOfBitsToRotate
  );
  static uint64_t rightRotateAsIfBigEndian64(
    uint64_t input, int numberOfBitsToRotate
  );
  static uint64_t rightShiftAsIfBigEndian64(
    uint64_t input, int numberOfBitsToShift
  );
  static uint64_t leftShiftAsIfBigEndian64(
    uint64_t input, int numberOfBitsToShift
  );
  ...
  public:
    ...
    static void getRandomBytesSecureInternalMayLeaveTracesInMemory(
      List<unsigned char>& output, int numberOfBytesMax32
    );
    static std::string getRandomHexStringLeaveMemoryTrace(
