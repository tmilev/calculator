...
output <<" <td>\n";
output <<" <FORM method=\"POST\" name=\"formMain\" action=\"../cgi-bin/vector_partition_linux_cgi\">\n";
...
output <<" </FORM>	\n";
output <<" <FORM method=\"POST\" name=\"formRootSAs\" action=\"../cgi-bin/vector_partition_linux_cgi\">\n";
