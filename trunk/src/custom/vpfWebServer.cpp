...
{ stOutput << HtmlInterpretation::GetExamPageInterpreter();
  return 0;
}
...
{ MacroRegisterFunctionWithName("WebWorker::ProcessEditPage");
  stOutput << HtmlInterpretation::GetEditPageHTML();
  return 0;
}

int WebWorker::ProcessClonePage()
{ MacroRegisterFunctionWithName("WebWorker::ProcessClonePage");
  stOutput << HtmlInterpretation::ClonePageResult();
  return 0;
}
