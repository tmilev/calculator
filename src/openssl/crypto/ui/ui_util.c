    ...
    case UIT_PROMPT:
        {
            ...
            const struct pem_password_cb_data *data = (const pem_password_cb_data *)
...
UI_METHOD *UI_UTIL_wrap_read_pem_callback(pem_password_cb *cb, int rwflag)
{
    ...
    if ((data = (pem_password_cb_data *) OPENSSL_zalloc(sizeof(*data))) == NULL
        ...
        || !RUN_ONCE(&get_index_once, ui_method_data_index_init, 0)
