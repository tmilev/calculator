...
public:
  ...
  std::string ElementToString(bool useHtml, bool useLatex, PolynomialOutputFormat* thePolyFormat);
...
//  bool flagHasSufficientlyManyVertices;
  ...
  std::string ElementToString(PolynomialOutputFormat* theFormat=0){return this->ElementToString(false, false, *theFormat);}
...
//  void MakeFromParSel(Vector<Rational> & parSel, WeylGroup& input);
 ...
 ;
  ...
  Vector<Rational> GetSimpleCoordinatesFromFundamental
  ...
  inline Rational WeylDimFormula(Vector<Rational> & theWeightInFundamentalCoords, GlobalVariables& theGlobalVariables)
  { return this->WeylDimFormula(theWeightInFundamentalCoords);
  }
  Rational GetScalarProdSimpleRoot(Vector<Rational> & input, int indexSimpleRoot)
  ...
  (Vector<Rational> & theWeight, int* sign=0, bool* stabilizerFound=0)
  ;
...
//  int GetNumRootsFromFormula();
  ...
  void ReflectBetaWRTAlpha(Vector<Rational> & alpha, Vector<Rational> & Beta, bool RhoAction, Vector<Rational> & Output);
  bool IsRegular(Vector<Rational> & input, int* indexFirstPerpendicularRoot);
  void RootScalarCartanRoot(const Vector<Rational> & r1, const Vector<Rational> & r2, Rational& output)const;
  ...
  Rational RootScalarCartanRoot(const Vector<Rational> & r1, const Vector<Rational> & r2)const{ Rational tempRat; this->RootScalarCartanRoot(r1, r2, tempRat); return tempRat; }
  ...
  bool IsDominantWeight(Vector<Rational> & theWeight);
...
(const Vector<Rational> & highestWeightSimpleCoord, DrawingVariables& theDV, GlobalVariables& theGlobalVariables, int theColor,
 int UpperBoundVertices)
  ...
  void GetMatrixOfElement(ElementWeylGroup& input, Matrix<Rational> & outputMatrix);
  bool GenerateOrbitReturnFalseIfTruncated(const Vector<Rational> & input, Vectors<Rational>& outputOrbit, int UpperLimitNumElements);
...
//    this->theLiebracketPairingIndices=(other.theLiebracketPairingIndices);
  ...
  std::string ElementToString(PolynomialOutputFormat* inputFormat);
...
public:
  ...
  std::string DebugString;
  std::string ElementToString
(bool useLatex, bool useCalculatorFormat, PolynomialOutputFormat* PolyFormatLocal, GlobalVariables& theGlobalVariables)const
;
  void ComputeDebugString()
  { GlobalVariables theGlobalVariables;
...
(std::string& output, bool useLatex,
 ...
 PolynomialOutputFormat& PolyFormatLocal, GlobalVariables& theGlobalVariables)const
  ;
  std::string ElementToString
  (bool useLatex, bool useCalculatorFormat, PolynomialOutputFormat& PolyFormatLocal,
  ...
  std::string ElementToString(PolynomialOutputFormat& PolyFormatLocal)const
  { GlobalVariables theGlobalVariables;
...
public:
  std::string ElementToString
  (PolynomialOutputFormat* theFormat=0)const
  ;
  List<SemisimpleLieAlgebra>* owners;
  int indexInOwners;
...
{ public:
  ...
  std::string ElementToString(PolynomialOutputFormat* theFormat=0);
  void init
...
class MonomialGeneralizedVerma
{
  ...
  std::string ElementToString
  (PolynomialOutputFormat* theFormat, bool includeV=true)const
  ;
  bool IsEqualToZero()const
  { return this->Coefficient.IsEqualToZero();
  }
...
public:
  ...
  std::string ElementToString(PolynomialOutputFormat* theFormat, bool includeV=true)
  ;
...
class rootsOLD : public List<Vector<Rational> >
{
public:
  ...
  bool ElementsHaveNonNegativeScalarProduct(const Vector<Rational> & theRoot)const;
  bool ElementsHavePositiveScalarProduct(const Vector<Rational> & theRoot)const;
  bool ElementsHaveNonPositiveScalarProduct(const Vector<Rational> & theRoot)const;
  ...
  bool PerturbVectorToRegular(Vector<Rational> &output, GlobalVariables& theGlobalVariables, int theDimension);
  void GetCoordsInBasis(Vectors<Rational>& inputBasis, Vectors<Rational>& outputCoords, GlobalVariables& theGlobalVariables);
  void ChooseABasis(GlobalVariables& theGlobalVariables);
  void average(Vector<Rational> & output, int theDimension);
  void sum(Vector<Rational> & output, int theDimension);
//  void sum(Vector<Rational> & output);
  void Pop(int index);
  void intersectWith(Vectors<Rational>& right, Vectors<Rational>& output);
  bool ContainsARootNonPerpendicularTo(Vector<Rational> & input, WeylGroup& theWeyl);
  bool ContainsARootNonStronglyPerpendicularTo(Vector<Rational> & input, WeylGroup& theWeyl);
  int NumRootsConnectedTo(Vector<Rational> & input, WeylGroup& theWeyl);
  bool LinSpanContainsRoot(Vector<Rational> & input, GlobalVariables& theGlobalVariables);
  bool IsRegular(Vector<Rational> & r, GlobalVariables& theGlobalVariables, int theDimension);
  bool IsRegular(Vector<Rational> & r, Vector<Rational> & outputFailingNormal, GlobalVariables& theGlobalVariables, int theDimension);
  bool GetMinLinearDependenceWithNonZeroCoefficientForFixedIndex(Matrix<Rational> & outputTheLinearCombination, int theIndex);
  //the below function returns a n row 1 column matrix with the coefficients in the obvious order
  bool GetLinearDependence(Matrix<Rational> & outputTheLinearCombination);
  void GetLinearDependenceRunTheLinearAlgebra(Matrix<Rational> & outputTheLinearCombination, Matrix<Rational> & outputTheSystem, Selection& outputNonPivotPoints);
  ...
  static bool ConesIntersect(GlobalVariables& theGlobalVariables,  List<Vector<Rational> >& StrictCone, List<Vector<Rational> >& NonStrictCone, int theDimension);
  static bool GetNormalSeparatingCones(GlobalVariables& theGlobalVariables, int theDimension, List<Vector<Rational> >& coneStrictlyPositiveCoeffs, List<Vector<Rational> >& coneNonNegativeCoeffs, Vector<Rational> & outputNormal);
  void GetGramMatrix(Matrix<Rational> & output, WeylGroup& theWeyl)const;
  //the following two functions assume the first dimension vectors are the images of the
  // vectors (1, 0, ..., 0), ..., (0, ..., 0, 1)
  void MakeBasisChange(Vector<Rational> & input, Vector<Rational> & output)const;
  void MakeBasisChange(Vectors<Rational>& input, Vectors<Rational>& output)const;
  void MakeEiBasis(int theDimension);
  void GaussianEliminationForNormalComputation (Matrix<Rational> & inputMatrix, Selection& outputNonPivotPoints, int theDimension)const;
  // the below function is slow
  int ArrangeFirstVectorsBeOfMaxPossibleRank(GlobalVariables& theGlobalVariables);
  void GetMatRootsToRows(Matrix<Rational> & output)const;
  void rootsToMatrixRationalTruncate(Matrix<Rational> & output);
  ...
  void SubSelection(Selection& theSelection, Vectors<Rational>& output);
  void SelectionToMatrix(Selection& theSelection, int OutputDimension, Matrix<Rational> & output);
  void SelectionToMatrixAppend(Selection& theSelection, int OutputDimension, Matrix<Rational> & output, int StartRowIndex);
  bool ComputeNormal(Vector<Rational> & output, int inputDim);
  bool ComputeNormalExcludingIndex(Vector<Rational> & output, int index, GlobalVariables& theGlobalVariables);
  bool ComputeNormalFromSelection(Vector<Rational> & output, Selection& theSelection, GlobalVariables& theGlobalVariables, int theDimension);
  bool ComputeNormalFromSelectionAndExtraRoot(Vector<Rational> & output, Vector<Rational> & ExtraRoot, Selection& theSelection, GlobalVariables& theGlobalVariables);
  bool ComputeNormalFromSelectionAndTwoExtraRoots(Vector<Rational> & output, Vector<Rational> & ExtraRoot1, Vector<Rational> & ExtraRoot2, Selection& theSelection, GlobalVariables& theGlobalVariables);
  void WriteToFile(std::fstream& output);
};
...
std::string MonomialTensorGeneralizedVermas<CoefficientType>::ElementToString
  (PolynomialOutputFormat* theFormat, bool includeV)
{ std::stringstream out;
  std::string tempS;
...
std::string MonomialGeneralizedVerma<CoefficientType>::ElementToString
  (PolynomialOutputFormat* theFormat, bool includeV)const
...
template <class CoefficientType>
std::string MonomialUniversalEnveloping<CoefficientType>::ElementToString(PolynomialOutputFormat* theFormat)const
{ std::stringstream out;
  std::string tempS;
...
(std::string& output, bool useLatex,
 bool useCalculatorFormat, PolynomialOutputFormat& PolyFormatLocal, GlobalVariables& theGlobalVariables)const
{ std::stringstream out;
  std::string tempS;
  if (this->size==0)
    out << "0";
