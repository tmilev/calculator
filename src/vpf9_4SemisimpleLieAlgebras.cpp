...
std::string SemisimpleLieAlgebra::ToStringHTMLMenuStructureSummary(
  ...
  out << "<hr>Page generated by the <a href='" << HtmlRoutines::githubRepository << "'>calculator project</a>. ";
  out << "</div>";
  return out.str();
}
...
//  << theGlobalVariables.GetElapsedSeconds()-startTimeDebug;
  ...
  if (writeToHD) {
    ...
    outFile << "<html>";
    outFile << HtmlRoutines::GetCSSLinkLieAlgebras("../../../");
    outFile << HtmlRoutines::GetJavascriptMathjax("../../../");
    outFile << HtmlRoutines::GetJavascriptLinkPanels("../../../");
    outFile << HtmlRoutines::GetJavascriptLinkGraphicsNDimensions("../../../");
    outFile << "<body>";
