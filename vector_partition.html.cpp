...
output <<" <input type=\"submit\" name=\"buttonSplitChambers\" value=\"Chambers+partial_fractions\">\n";
output <<" <br>\n";
...
output <<" <br> \n";
output <<" <a href=\"/cgi-bin/vector_partition_linux_cgi.cgi?rootSAs\">Root subalgebras</a>\n";
output <<" <br> \n";
