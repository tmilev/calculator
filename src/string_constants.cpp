...
std::string WebAPI::result::SolutionData::expressionType            = "expressionType"              ;
...
std::string WebAPI::request::onePageJS                    = "/calculator_html/javascript_all_in_one.js"                          ;
std::string WebAPI::request::onePageJSWithHash            = "/calculator_html/javascript_all_in_one.js"                          ;
std::string WebAPI::request::calculatorWorkerJS           = "/calculator_html/web_assembly/calculator_web_assembly_all_in_one.js";
std::string WebAPI::request::calculatorWorkerJSWithHash   = "/calculator_html/web_assembly/calculator_web_assembly_all_in_one.js";
std::string WebAPI::request::calculatorCSS                = "/calculator_html/calculator.css"                                    ;
std::string WebAPI::request::lieAlgebrasCSS               = "/calculator_html/style_lie_algebras.css"                            ;
