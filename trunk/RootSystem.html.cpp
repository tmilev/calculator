...
output << " </head>\n";
output << " <body>\n";
output << " <form method=\"POST\" name=\"formCalculator\" action=\"/cgi-bin/calculator\">\n";
output << " <textarea name=\"textInput\" style=\"width:100px; height:50px\" id=\"textInputID\" onkeypress=\"if (event.keyCode == 13) {this.form.submit(); return false;}\">\n";
output << " Some text\n";
output << " </textarea>\n";
output << " <input type=\"submit\" name=\"buttonGo\" value=\"Go\" onmousedown=\"storeSettings()\">\n";
output << " </form>\n";
output << " \n";
output << " \n";
}
...
output << " \n";
output << "  <select name=\"textType\" id=\"textType\" onchange=\"makeCartanArbitrary(document.getElementById('textType'), document.getElementById(textDim)); storeSettings(); this.form.submit();\">\n";
...
output << " </select>\n";
output << " <select name=\"textDim\" id=\"textDim\" onchange=\"makeCartanArbitrary(document.getElementById('textType'), document.getElementById(textDim)); storeSettings(); this.form.submit();\">\n";
...
output << " //changeBasis(1, 50, 50); drawOnCanvasMain();\" DOMMouseScroll=\"mouseHandleWheel(event);\" onmousewheel=\"mouseHandleWheel(event);\" onmouseup=\"ButtonIsDown=false; selectedBasisIndex=-1;\"></div>\n";
output << " <br>\n";
...
output << " \n";
output << "  \n";
output << " function mouseHandleWheel(theEvent)\n";
output << " { theEvent = theEvent ? theEvent : window.event;\n";
output << "   theEvent.preventDefault(); \n";
output << "   theEvent.stopPropagation();\n";
output << "   theWheelDelta = theEvent.detail ? theEvent.detail * -1 : theEvent.wheelDelta / 40;\n";
output << "   //alert(\"mousewheel detected! delta: \"+theWheelDelta);\n";
output << "   GraphicsUnit+=theWheelDelta;\n";
output << "   ComputeProjections();\n";
output << "   drawOnCanvasMain();\n";
output << " }\n";
output << " \n";
