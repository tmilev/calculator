...
{ if (this->type!=this->typeRationalFunction)
  ...
  { std::cout << "This is a programming error generated by RationalFunctionOld Data::GetValuE . "
    << " A rational of index "
    << this->theIndex << " is requested but the size of the array of rationals is "
...
{ if (this->type!=this->typeLSpath)
  ...
  if (this->theIndex>=this->owner->theObjectContainer.theLSpaths.size || theIndex<0)
  { std::cout << "This is a programming error generated by LittelmannPath Data::GetValuE . "
    << " A path of index "
    << this->theIndex << " is requested but the size of the path array is "
    << this->owner->theObjectContainer.theLSpaths.size
    << ". " << CGI::GetStackTraceEtcErrorMessage(__FILE__, __LINE__ );
    assert(false);
  }
...
{ if (this->type!=this->typeLittelmannRootOperator)
  ...
  if (this->theIndex>=this->owner->theObjectContainer.theLittelmannOperators.size || this->theIndex<0)
  { std::cout << "This is a programming error generated by LittelmannPath Data::GetValuE . "
    << " A path of index "
    << this->theIndex << " is requested but the size of the path array is "
    << this->owner->theObjectContainer.theLittelmannOperators.size
    << ". " << CGI::GetStackTraceEtcErrorMessage(__FILE__, __LINE__ );
    assert(false);
  }
...
template < >
const RationalAlgebraic& Data::GetValuE()const
{ if (this->type!=this->typeRationalRadical)
  ...
  if (this->theIndex>=this->owner->theObjectContainer.theRationalRadicals.size || theIndex<0)
  { std::cout << "This is a programming error generated by typeRationalRadical Data::GetValuE. "
    << " A rational algebraic of index "
    << this->theIndex << " is requested but the size of the array of rational algebraic numbers is "
    << this->owner->theObjectContainer.theRationalRadicals.size
    << ".  "
    << CGI::GetStackTraceEtcErrorMessage(__FILE__, __LINE__);
    assert(false);
  }
  return this->owner->theObjectContainer.theRationalRadicals[this->theIndex];
}
...
template <>
bool Data::ConvertToTypE<RationalAlgebraic>()
{ RationalAlgebraic output;
  switch (this->type)
...
//        ToString(*this->owner->theGlobalVariableS);
    ...
    case Data::typeRationalRadical:
      return this->GetValuE<RationalAlgebraic> ().ToString();
...
{ this->owner=&theBoss;
  ...
  this->theIndex=theBoss.theObjectContainer.theRationalRadicals.AddNoRepetitionOrReturnIndexFirst
  (inputRationalRad);
  this->theContextIndex=-1;
}
...
//   "d{}{{a}}:=Differential{}a;\nx:=Polynomial{}x;\nd{}(x^2/(x+1))");
  ...
  ("\\sqrt", & this->fSqrt, "",
   ...
   "\\sqrt{}(2/3)+\\sqrt{}2+\\sqrt{}3+\\sqrt{}{3/2}+2");
  this->AddNonBoundVarMustBeNew
...
{ MacroRegisterFunctionWithName("Data::AddRatOrAlgebraicToRatOrAlgebraic");
  output=left;
  Data rightCopy=right;
  output.ConvertToTypE<RationalAlgebraic>();
  rightCopy.ConvertToTypE<RationalAlgebraic>();
  RationalAlgebraic resultAlg=output.GetValuE<RationalAlgebraic>();
  resultAlg+=rightCopy.GetValuE<RationalAlgebraic>();
