...
{ std::stringstream out;
  ...
  << "\n<br>\nAlternatively, if you installed mysql and openssl in the preceding optional step, you can use the following command. "
  << "\n<br>\n make"
  << "\n<br>\nWait until the command is completed (takes about 4 minutes on my machine). "
