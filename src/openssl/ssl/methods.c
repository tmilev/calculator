...
const ssl_method_st* tlsv1_3_server_method() {
  static ssl_method_st result;
  return result.initializeTLS(
  "TLS1_3_VERSION", TLS1_3_VERSION, 0, SSL_OP_NO_TLSv1_3,
                          ossl_statem_accept,
...
const ssl_method_st* tlsv1_2_server_method() {
  static ssl_method_st result;
  return result.initializeTLS(
  "TLS1_2_VERSION", TLS1_2_VERSION, 0, SSL_OP_NO_TLSv1_2,
                          ,
                          ossl_statem_accept,
...
const ssl_method_st* tlsv1_1_server_method() {
  static ssl_method_st result;
  return result.initializeTLS(
  "TLS1_1_VERSION", TLS1_1_VERSION, SSL_METHOD_NO_SUITEB, SSL_OP_NO_TLSv1_1,
                          ,
                          ossl_statem_accept,
...
IMPLEMENT_ssl3_meth_func("sslv3_server_method", sslv3_server_method,
