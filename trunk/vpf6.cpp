...
//    std::cout << "<br>" << j+1 << ": " << theRatio.ToString() << "=? " << tempRat.ToString();
  ...
  out << "</table>";
  out
  << "<hr>The fundamental weights (the j^th fundamental weight is the weight that has scalar product 1 "
  << " with the j^th simple root times 2 divided by the root length squared, and 0 with the remaining simple Vectors<Rational>): ";
  ...
  out << "</table>";
  out << "<hr>Root system:<table><tr><td>Simple basis coordinates</td><td></td><td>Epsilon coordinates (convention: see below)</td></tr> ";
  ...
  << " of Humphreys, Introduction to Lie algebras and representation theory, page 65. <br> For F_4, we follow the "
