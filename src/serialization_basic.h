...
public:
  ...
  public:
    friend std::ostream& operator<<(
      std::ostream& output, const Serialization::Marker& marker
    ) {
  ...
  public:
    ...
    inline void initialize(
      ...
      Serialization::writeNByteUnsigned(
        this->numberOfBytes, input, output, notUsed
      );
      ...
      this->outputMarkers->addOnTop(
        Serialization::Marker(this->offset, - 1, label)
      );
      this->outputMarkers->addOnTop(
    ...
    ~WriterIntegerWithMarker() {
      ...
      (*(this->outputMarkers))[this->markerOffset].length =
      this->outputPointer->size - this->offset;
  ...
  public:
    ...
    WriterIntegerWithMarker(
      numberOfBytesTemplate, input, output, outputMarkers, label
    ) {}
    WriterIntegerWithMarkerTemplate(
      unsigned int input,
      List<unsigned char>& output,
  ...
  public:
      ...
      if (this->outputMarkers != nullptr) {
        ...
        this->outputMarkers->addOnTop(
          Serialization::Marker(
            this->offset, - 1, Serialization::JSLabels::length
          )
        );
        this->outputMarkers->addOnTop(
    ...
    ~LengthWriterNBytes() {
      ...
      if (this->outputMarkers != nullptr) {
        (*this->outputMarkers)[this->markerOffset].length =
        totalLength + this->numberOfBytes;
      }
      this->outputMarkers = nullptr;
      this->outputPointer = nullptr;
    }
  ...
  static void writeNByteUnsigned(
  ...
  static void writeTwoByteInt(int input, List<unsigned char>& output);
  static void writeThreeByteInt(int input, List<unsigned char>& output);
  ...
  static void writeTwoByteUnsigned(
    unsigned int input, List<unsigned char>& output
  );
  ...
  static std::string convertListUnsignedCharsToString(
    const List<unsigned char>& input
  );
};
