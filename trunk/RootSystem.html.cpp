...
output << " When you drag a basis vector, you are modifying e_1 and e_2 with a multiple of this basis vector,<br>\n";
output << " in the unique possible fashion so the basis vector points where you mouse is.<br>\n";
output << " \n";
...
output << " }\n";
output << " \n";
output << " function changeBasis(selectedIndex, theShiftX, theShiftY)\n";
...
output << "   var shiftXVi=theShiftX/selectedRootLength;\n";
output << "   var shiftYVi=theShiftY/selectedRootLength;  \n";
output << "   var theScalarProd;\n";
output << "   for (var i=0; i<theWeylDim; i++)\n";
output << "   { theScalarProd= getScalarProduct(selectedRoot, theRootSystem[i]);\n";
output << "     Basis[i][0]+=shiftXVi*theScalarProd;\n";
output << "     Basis[i][1]+=shiftYVi*theScalarProd;\n";
output << "   }\n";
output << " }\n";
output << "  \n";
...
output << "     }\n";
output << " 		else\n";
output << "     {	var tempShiftX= -Basis[selectedBasisIndex][0]+posx;\n";
output << "       var tempShiftY= -Basis[selectedBasisIndex][1]+posy;\n";
output << "       changeBasis(selectedBasisIndex, tempShiftX, tempShiftY);\n";
output << "     }\n";
output << "     drawOnCanvasMain();\n";
output << "   }\n";
output << " }\n";
