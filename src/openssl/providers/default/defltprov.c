...
#include "../common/include/internal/provider_algs.h"
...
static const OSSL_ITEM *deflt_get_param_types(const ossl_provider_st *prov)
{
    return deflt_param_types;
}

static int deflt_get_params(const ossl_provider_st *prov,
...
static const OSSL_ALGORITHM *deflt_query(ossl_provider_st *prov,
                                         int operation_id,
                                         int *no_cache)
{
    *no_cache = 0;
...
int ossl_default_provider_init(
