...
int ec_GFp_mont_group_copy(EC_GROUP *dest, const EC_GROUP *src)
{
    ...
    if (src->field_data2 != NULL) {
        dest->field_data2 = BN_dup((BIGNUM*) src->field_data2);
                            ...
                            BN_CTX *ctx)
{
     ...
     */
    if (!BN_mod_exp_mont(r, a, e, group->field, (BN_CTX*) ctx, (BN_MONT_CTX*) group->field_data1))
        goto err;
                                 ...
                                 BN_CTX *ctx)
{
    ...
    if (!BN_copy(r, (BIGNUM*) group->field_data2))
        return 0;
    return 1;
}
