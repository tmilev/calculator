...
class ReductiveSubalgebraComponent{
public:
  List<CartanElementCandidate> cartanElements;
...
class CentralizerComputer {
  ...
  void  mergeReductiveComponents(List<int>& indicesOfComponentsToBeMergedSorted);
...
public:
  ...
  List<ReductiveSubalgebraComponent> reductiveComponents;
