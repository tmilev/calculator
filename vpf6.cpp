...
ElementSimpleLieAlgebra& Data::GetEltSimpleLieAlgebra()const
{ if (this->type!=this->typeElementSSalgebra)
  ...
  int theIndex=this->GetSmallInt();
  if (theIndex>=this->owner->theMonomialsGeneralizedVerma.size || theIndex<0)
  { std::cout << "This is a programming error generated by Data::GetEltSimpleLieAlgebra. "
    ...
    << this->owner->theMonomialsGeneralizedVerma.size
    << ". Please debug file " << __FILE__ << " line " << __LINE__ << ". ";
    assert(false);
  }
  return this->owner->theLieAlgebraElements[theIndex];
}
...
{ if (this->type!=this->typeMonomialGenVerma)
  ...
  { std::cout << "This is a programming error generated by Data::GetMonGenVerma. A monomial of index "
    << theIndex << " is requested but the size of the array of monomials is " << this->owner->theMonomialsGeneralizedVerma.size
    << ". Please debug file " << __FILE__ << " line " << __LINE__ << ". ";
    assert(false);
  }
  return this->owner->theMonomialsGeneralizedVerma[theIndex];
}
...
{ if(this->owner!=other.owner)
  ...
  { case Data::typeSSalgebra:
    ...
    default:
      ...
      << this->ElementToStringDataType() << " Please debug file " << __FILE__ << " line " << __LINE__ << ".";
      assert(false);
      return false;
  }
}
...
{ switch (this->type)
  { case Data::typeSSalgebra:
    ...
    default:
      ...
      << this->ElementToStringDataType() << ", please debug line " << __LINE__;
      assert(false);
      return 0;
  }
}
...
//        ElementToString(*this->owner->theGlobalVariableS);
      return out.str();
    case Data::typeMonomialGenVerma:
      out << this->owner->theMonomialsGeneralizedVerma[this->GetSmallInt()].ElementToString
      (*this->owner->theGlobalVariableS, this->owner->theGlobalVariableS->theDefaultFormat, true);
      return out.str();
    case Data::typeElementSSalgebra:
      out << this->owner->theLieAlgebraElements[this->GetSmallInt()].ElementToString();
      return out.str();
    case Data::typeRational:
