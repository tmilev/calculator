...
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/polyhedra.cpp?view=markup\"> Vector partition c++ source(1 out of 2 files)</a>\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/polyhedra.h?view=markup\"\"> Vector partition c++ source(2 out of 2 files)</a>\n";
output <<" <br>\n";
