...
{ //(*Initialize(wxParserFrame)
  ...
  TextCtrl1 = new wxTextCtrl(this, ID_TEXTCTRL1, _("fSplitFDpartB3overG2{}(x_1,2,0)"), wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE, wxDefaultValidator, _T("ID_TEXTCTRL1"));
