...
output <<" <HTML>\n";
output <<" <HEAD><TITLE>Vector partition revision 563, 6 July 2010</TITLE>\n";
output <<" </HEAD>\n";
output <<" <BODY>\n";
output <<" <table>\n";
...
output <<" <input type=\"submit\" name=\"buttonSplitChambers\" value=\"Chambers_and_partial_fractions\">\n";
output <<" <br>\n";
output <<" <input type=\"submit\" name=\"buttonOneChamber\" value=\"Vector_partition_function_chamber_#\">\n";
...
output <<" <br>\n";
output <<" Contact: Todor Milev\n";
output <<" <br>\n";
output <<" email: t.milev  at jacobs-university.de\n";
output <<" <br>\n";
output <<" If you find any bugs, especially mathematical,\n";
output <<" <br>\n";
output <<" please email me! Thanks in advance!\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/polyhedra.cpp?view=markup\"> Vector partition c++ source(1 out of 3 main files)</a>\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/polyhedra.h?view=markup\"> Vector partition c++ source(2 out of 3 main files)</a>\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/custom_code_here.cpp?view=markup\"> Vector partition c++ source(3 out of 3 main files)</a>\n";
output <<" <br>\n";
output <<" Requires <a href=\"http://httpd.apache.org/\">Apache server</a> installed:\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/vp_cgi_interface.cpp?view=markup\"> Server c++ source(1 out of 2 files)</a>\n";
output <<" <br>\n";
output <<" <a href=\"http://vectorpartition.svn.sourceforge.net/viewvc/vectorpartition/trunk/vector_partition.html.cpp?view=markup\"> Server c++ source(2 out of 2 files)</a>\n";
output <<" <br> <a href=\"http://vectorpartition.sourceforge.net/\">Sourceforge project page</a>\n";
output <<" <br>\n";
output <<" <br>\n";
...
output <<" 		}\n";
output <<" 	}\n";
output <<" 	function generatePageFromDimAndNum(inputDim,inputNum,posIntextDim, ChamberDisplayIndex)\n";
...
output <<" 		{	return;\n";
output <<" 		}\n";
output <<" 		document.formMain.chamberNumber.value=ChamberDisplayIndex;\n";
...
output <<" //generatePageFromDimAndNum(3,9,-1,-1);\n";
output <<" </script>\n";
output <<" \n";
output <<" \n";
output <<" \n";
