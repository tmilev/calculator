...
//        ElementToString(*this->owner->theGlobalVariableS);
    ...
    case Data::typeMonomialGenVerma:
      ...
      (*this->owner->theGlobalVariableS, this->owner->theGlobalVariableS->theDefaultLieFromat, true);
      return out.str();
    case Data::typeElementSSalgebra:
      out << this->owner->theObjectContainer.theLieAlgebraElements[this->theIndex].ElementToString();
      return out.str();
    case Data::typeRational:
...
void Data::MakeSSAlgebra
  (CommandList& theBoss, const SemisimpleLieAlgebra& inputAlgebra)
{ this->owner=&theBoss;
  this->type=this->typeSSalgebra;
  this->theIndex=theBoss.theObjectContainer.theLieAlgebras.AddNoRepetitionOrReturnIndexFirst(inputAlgebra);
}
...
{ switch (this->type)
  { case Data::typeSSalgebra:
    ...
    case Data::typePoly:
    case Data::typeRational:
      return this->theIndex*this->type;
    case Data::typeError:
...
//  }
  ...
  (theWeylLetter, theRank, theCommands.theObjectContainer.theLieAlgebras, *theCommands.theGlobalVariableS);
  Data tempData;
  tempData.MakeSSAlgebra(theCommands, theSSalgebra);
